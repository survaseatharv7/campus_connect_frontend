            ...
            <motion.div key={note.id} initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: idx * 0.05 }}>
              <Card className="group">
                ...
                <div className="flex items-center justify-between mt-auto">
                  ...
                  {note.fileUrl && (
                    <a href={fixCloudinaryUrl(note.fileUrl)} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1 text-sm text-primary-600 hover:text-primary-700 font-medium">
