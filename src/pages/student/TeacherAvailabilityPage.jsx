                    ...
                    >
                      <Card className="group hover:shadow-2xl hover:shadow-primary-500/10 transition-all duration-500 border-dark-100/60 rounded-[2rem] overflow-hidden">
                        <div className="p-7 space-y-6">
                          ...
                          <button className="w-full py-3 px-5 bg-dark-900 rounded-2xl text-sm font-bold text-white hover:bg-primary-600 hover:-translate-y-1 transition-all duration-300 shadow-lg shadow-dark-200 flex items-center justify-center gap-3">
                             Consult Online
                          </button>
                        </div>
                      </Card>
